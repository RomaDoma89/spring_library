...
public class BookServiceImpl implements BookService {
  ...
  @Override
  public List<Book> getAllBooks()throws NoResultException {
    return bookDao.retrieveAll();
  }

  @Override
  public List<Copy> isBookAvailable(String title)throws NoResultException {
    ...
    @Override
    public List<Book> findBookByAuthor(String name)throws NoResultException {
